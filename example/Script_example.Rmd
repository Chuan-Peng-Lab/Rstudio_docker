---
title: "Notebook| Example Rmarkdown script"
output:
  html_document:
    df_print: paged
---
**Note: this notebook cannot be knitted inside docker container, run R script instead.**

This is an example [R Markdown](http://rmarkdown.rstudio.com) Notebook.

The data and script were adopted from our previous [validation study](https://github.com/AaronZheng87/Asso_Learn_Online) of JsPsych. 
...
```{r plot, fig.cap="Valence effect of moral valence on RT & d'", fig.height=6, fig.width=8, warning=FALSE, message=FALSE}
